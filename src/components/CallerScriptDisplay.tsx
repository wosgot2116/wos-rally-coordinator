...
import type { ScriptLine } from '../rally/scriptEngine'

type CallerScriptDisplayProps = {
  cueHeading?: ReactNode
  membersCount: number
  showScriptStack: boolean
  stageActions?: ReactNode
  cue: string
  stackLines: ScriptLine[]
  scriptSecond: number
}
...
export function CallerScriptDisplay({
  cueHeading,
  membersCount,
  showScriptStack,
  stageActions,
